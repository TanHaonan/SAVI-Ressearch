...
Mode-agnostic: the caller passes the prompt string for the per-slot readout."""
...
# shared model-loading + scoring helpers (vendored alongside this file)
C = _by_path("dep_common", HERE / "common.py")
