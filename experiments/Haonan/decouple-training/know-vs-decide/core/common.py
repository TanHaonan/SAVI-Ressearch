"""Shared model-loading, answer-scoring, and metrics helpers. Frozen instruct model, eval-only.
...
# Qwen/Qwen3-4B is the same architecture/size as Qwen3-4B-Instruct-2507; we run it with thinking
# DISABLED so it answers directly like the instruct variant. Swap via --model as needed.
# cache_dir falls back to the transformers default when HF_HOME is unset.
CH = os.environ.get("HF_HOME") and os.path.join(os.environ["HF_HOME"], "hub") or None
