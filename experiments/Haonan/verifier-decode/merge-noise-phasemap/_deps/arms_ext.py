...
_HERE = os.path.dirname(os.path.abspath(__file__))           # merge-noise-phasemap/_deps/
_PACKAGE_PARENT = os.path.dirname(os.path.dirname(_HERE))    # verifier-decode/ (holds decode_core/)
