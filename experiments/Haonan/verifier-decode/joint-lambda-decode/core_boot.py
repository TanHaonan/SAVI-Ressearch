...
# Default location of the emission line's countdown-decode package (the seam). Override
# with COUNTDOWN_DECODE_DIR if the worktree layout differs.
_DEFAULT_COUNTDOWN_DECODE = (
    "contrib-savi/experiments/Haonan/decouple-training/countdown-decode"
)
